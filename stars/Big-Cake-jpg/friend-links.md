...
```json
{
    "url": "https://www.notbigcake.net",
    "avatar": "https://objects.notbigcake.net/bigcake-blog-images/brand/avatar-128x.webp",
    "name": "Big_Cake",
    "color": "#F2BC57",
    "blog": "晓雨杂记",
...
感谢 [SerinaNya](https://serinanya.cn) 编写的基于 Python 的新版查活 bot，虽然源代码只在 Origami Network 的内网 Git 仓库中可用。
